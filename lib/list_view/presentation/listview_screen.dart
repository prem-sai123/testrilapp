  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:  Column(
          children: const [
             Text('Gate Entries',textAlign: TextAlign.justify),
             Text('search Bar')
          ],
        ),
        toolbarHeight: 70,
                ...
                child: NotificationListener<UserScrollNotification>(
                  onNotification: (notification) {
                    if (notification.direction == ScrollDirection.forward) {
                      setState(() => _fabVisble = true);
                    } else if (notification.direction ==
                        ScrollDirection.reverse) {
                      setState(() => _fabVisble = false);
                    }
                    return true;
                  },
                        ...
                        child: ListTile(
                          ...
                          leading: Padding(
                            ...
                            child: CircleAvatar(
                              ...
                              radius: 20,
                              child: Text(_setTransactionAvatarString(
                                  myVar[index].transactionType
                                      as TransactionType)!),
                            ),
                          ),
                          title: Container(
      ...
      floatingActionButton: _fabVisble!
                    ...
                    builder: (_) => BlocProvider<AddEntryCubit>(
                      ...
                      child: BlocProvider<BusinessPartnerCubit>(
                        ...
                        child: BlocProvider.value(
                          value: BusinessPartnerCubit()..fetchBPRecords(widget.prefName!,widget.prefPass!),
                          child: AddGateEntryScreen(
                              prefName: widget.prefName!,
                              prefPass: widget.prefPass!),
                        ),
                      ),
                    ),
                  ),
